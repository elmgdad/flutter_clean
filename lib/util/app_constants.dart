...
class AppConstants {
  static const String appName = 'MyTime';
  static const String baseUrl = 'http://chicken-fruits.com/6cash';
  ...
  static List<OnboardModel> onboardList = [
    OnboardModel(Images.onboardImage1, Images.onboardBackground1, '', ''
    ...
    OnboardModel(Images.onboardImage3, Images.onboardBackground3, '', ''
