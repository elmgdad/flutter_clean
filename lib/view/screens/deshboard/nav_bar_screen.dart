            ...
            child: Row(
              ...
              children: [
                customBottomItem(
                  ...
                  icon: menuController.currentTab == 0 ? Images.homeIconBold : Images.homeIcon,
                  name: 'home'.tr,
                  selectIndex: 0,
                ),
                ...
                customBottomItem(
                  ...
                  icon: menuController.currentTab == 2 ? Images.notificationIconBold : Images.notificationIcon,
                  name: 'notification'.tr,
                  selectIndex: 1,
                ),
                customBottomItem(
                  tap: () => menuController.selectProfilePage(),
                  icon: menuController.currentTab == 3 ? Images.profileIconBold : Images.profileIcon,
                  name: 'profile'.tr,
                  selectIndex: 2,
                ),
              ],
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          SizedBox(
            ...
            child: Image.asset(
              icon,
              fit: BoxFit.contain,
              color: Get.find<MenuItemController>().currentTab == selectIndex ? Theme.of(context).textTheme.titleLarge!.color : ColorResources.nevDefaultColor,
            ),
          ),
